...
const Test = () => {
    ...
    return (
        <Grid padded className="test-component">
            <Grid.Column className="test-column">
                <Header as="h2" className="equity-bridge-header">4. Equity Bridge</Header>
                <Divider/>

                <Header as="h3" className="liquide-mittel-header">
